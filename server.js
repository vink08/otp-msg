...
// // Vonage Configuration - Updated for newer SDK versions
// const { Vonage } = require('@vonage/server-sdk');
// // Import the SMS module specifically
// const { SMS } = require('@vonage/sms');

// // Create Vonage instance
// const vonage = new Vonage({
//   apiKey: process.env.VONAGE_API_KEY || "acb15941",
//   apiSecret: process.env.VONAGE_API_SECRET || "dBitrzJ4K3eWwmxB"
// });

// // Create SMS client
// const smsClient = new SMS(vonage);
...
// // Send a message with OTP using Vonage
...
//       // Send SMS using the new Vonage SMS client
...
//       // Check if the message was sent successfully - response structure is different in newer SDK
//       if (response && response.messages && response.messages[0].status === '0') {
...
//           messageId: response.messages[0].message_id || response.messages[0]['message-id']
//         };
...
//         });
//       } else {
//         const errorText = response && response.messages && response.messages[0] ? 
//           response.messages[0]['error-text'] || response.messages[0].error_text : 'Unknown error';
...
//       }
//     } catch (vonageError) {
//       console.error('Vonage error details:', vonageError);
//       return res.status(500).json({ 
//         error: 'Failed to send SMS via Vonage',
